    ...
    <section className="what-academies-are-section">
      ...
      <div className="academy-list">
        ...
        <div className="academy-item">
            ...
            <p><a href="https://uscga.edu/admissions/apply/" target="_blank" rel="noopener noreferrer">Admissions Information</a></p>
        </div>
        <div className="academy-item">
        ...
        <div className="academy-item">
            ...
            <p><a href="https://www.westpoint.edu/admissions/steps-to-admission" target="_blank" rel="noopener noreferrer">Admission Steps</a></p>
        </div>
      </div>
    </section>
